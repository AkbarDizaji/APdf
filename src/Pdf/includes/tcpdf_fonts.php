...
class TCPDF_FONTS {
			...
			if ($fmetric['type'] == 'cidfont0') {
				...
				switch ($fonttype) {
					case 'CID0JP': {
						...
						$pfile .= 'includes(dirname(__FILE__).\'/uni2cid_aj16.php\');'."\n";
						break;
					}
					case 'CID0KR': {
						$pfile .= '// Korean'."\n";
						...
						$pfile .= 'includes(dirname(__FILE__).\'/uni2cid_ak12.php\');'."\n";
						break;
					}
					case 'CID0CS': {
						...
						$pfile .= 'includes(dirname(__FILE__).\'/uni2cid_ag15.php\');'."\n";
						break;
					}
					case 'CID0CT':
					default: {
	...
	public static function _getTrueTypeFontSubset($font, $subsetchars) {
		...
		// includes all parts of composite glyphs
